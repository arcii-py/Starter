<template>
    <div>
      ...
      <div :class="{ 'open': menuOpen }"
        ...
        <div class="flex flex-col justify-center items-center space-y-4 h-full px-4 py-8">
          ...
          <button @click="toggleMenu" class="close-button text-black hover:text-yellow-300 transition-all duration-300">
            Close</button>
        </div>
      </div>
    </div>
